...
class Config:
    ...
    # Model settings - Fine-tuned dataset research field classifier
    model_name: str = "jimnoneill/dataset-to-field"  # Fine-tuned on OpenAlex taxonomy
    ...
    def distilled_model_path(self) -> Path:
        ...
        return self.models_dir / "dataset-to-field"
